...
public class GivenProductsFragment extends ProductListFragment {


    @Override
    protected BaseFragment newInstance() {
        return new GivenProductsFragment();
    }
    ...
    protected void HttpRequest() {
        ...
        this.disposable = ApiStreams.streamFetchProductsFollowingSupplier(

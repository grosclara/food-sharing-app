...
public class ProductViewHolder extends RecyclerView.ViewHolder {
    ...
    @BindView(R.id.fragment_product_list_item_status)
    TextView textViewStatus;
    @BindView(R.id.fragment_product_list_item_image)
    ...
    public ProductViewHolder(@NonNull View itemView) {
        ...
        textViewProductName = itemView.findViewById(R.id.fragment_product_list_item_name);
    }

        ...
        public void updateWithProduct(Product product){
            ...
            switch (product.getStatus()) {
                case Constants.AVAILABLE:
                    ...
                    textViewStatus.setTextColor(context.getColor(R.color.colorAvailable));
                    break;
                case Constants.COLLECTED:
                    textViewStatus.setText(R.string.collected);
                    textViewStatus.setTextColor(context.getColor(R.color.colorCollected));
                    break;
                case Constants.DELIVERED:
                    textViewStatus.setText(R.string.delivered);
                    textViewStatus.setTextColor(context.getColor(R.color.colorDelivered));
                    break;
                default:
            }
